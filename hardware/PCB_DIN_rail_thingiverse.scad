...
/* x,y,radius*/
/*radiiPoints = [
                    [(PCB_length/2)+2.5,0,      0],
                    [(PCB_length/2)+2.5,-11.3,  2.5],     //angle right top
                    [20,                -11.3,  0],
                    [20,                -33.3,2],                       //angle hook right
                    [16.75,-33.3,0],
                    [16.75,-32,0],
                    [17.75,-32,0],
                    [17.75,-30.5,0],
                    [14.5,-30.5,0],
                    [0,-11.3,6],                        //angle center
                    [-14.5,-30.5,0],
                    [-16.25,-30.5,0],
                    [-17,-10.5,0],                      //angle lip
                    [-17.25,-31.75,0],
                    [-16.25,-31.75,0],
                    [-17.5,-33,0],
                    [-25,-33,2],                        //angle hook left
                    [-25,-28,0],
                    [-23,-28,0],
                    [-23,-31,0],
                    [-20,-31,0],
                    [-19,-11.3,0],
                    [-(PCB_length/2)-2.5,-11.3,2.5], // angle left top
                    [-(PCB_length/2)-2.5,0,0]];*/
                    
 
 radiiPoints = [
                    [(PCB_length/2)+2.5,0,                              0],
                    [(PCB_length/2)+2.5,-9.5-PCB_thickness-Tollerance,  2.5],     //angle right top
                    [20,                -9.5-PCB_thickness-Tollerance,  0],
                    [20,                -31.5-PCB_thickness-Tollerance, 2],      //angle hook right
                    [16.75,             -31.5-PCB_thickness-Tollerance, 0],
                    [16.75,             -30.5-PCB_thickness-Tollerance, 0],
                    [17.75,             -30.2-PCB_thickness-Tollerance, 0],
                    [17.75,             -28.7-PCB_thickness-Tollerance, 0],
                    [14.5,              -28.7-PCB_thickness-Tollerance, 0],
                    [0,                 -9.5-PCB_thickness-Tollerance,  6],       //angle center
                    [-14.5,             -28.7-PCB_thickness-Tollerance, 0],
                    [-16.25,            -28.7-PCB_thickness-Tollerance, 0],
                    [-17,               -8.7-PCB_thickness-Tollerance,  0],       //angle lip
                    [-17.25,            -29.95-PCB_thickness-Tollerance,0],
                    [-16.25,            -29.95-PCB_thickness-Tollerance,0],
                    [-17.5,             -31.2-PCB_thickness-Tollerance, 0],
                    [-25,               -31.2-PCB_thickness-Tollerance, 2],      //angle hook left
                    [-25,               -26.2-PCB_thickness-Tollerance, 0],
                    [-23,               -26.2-PCB_thickness-Tollerance, 0],
                    [-23,               -29.2-PCB_thickness-Tollerance, 0],
                    [-20,               -29.2-PCB_thickness-Tollerance, 0],
                    [-19,               -9.5-PCB_thickness-Tollerance,  0],
                    [-(PCB_length/2)-2.5,-9.5-PCB_thickness-Tollerance, 2.5],    // angle left top
                    [-(PCB_length/2)-2.5,0,                             0]];
 
 

translate([0,-1,0])difference(){ 
    linear_extrude((PCB_width/2)+2.5){
        polygon(polyRound(radiiPoints,30));
    }

linear_extrude((PCB_width/2)-2.5){
    translate([0,-(7+PCB_thickness+0.25)/2,0]){
        square([PCB_length-5,7+PCB_thickness+0.25], center = true);
    }
}

linear_extrude((PCB_width/2)+0.25){
    translate([0,-(2+PCB_thickness+0.25)/2,0]){
        square([PCB_length+0.25,PCB_thickness+0.25], center = true);
    }
}
}
...
radiiPoints = [
                    [(PCB_length/2)+2.5,0,0],
                    [(PCB_length/2)+2.5,-9.5-PCB_thickness,2.5],     //angle right top
                    [20,-9.5-PCB_thickness,0],
                    [20,-31.5-PCB_thickness,2],                 //angle hook right
                    [16.75,-31.5-PCB_thickness,0],
                    [16.75,-30.5-PCB_thickness,0],
                    [17.75,-30.2-PCB_thickness,0],
                    [17.75,-28.7-PCB_thickness,0],
                    [14.5,-28.7-PCB_thickness,0],
                    [0,-9.5-PCB_thickness,6],       //angle center
                    [-14.5,-28.7-PCB_thickness,0],
                    [-16.25,-28.7-PCB_thickness,0],
                    [-17,-8.7-PCB_thickness,0],                //angle lip
                    [-17.25,-29.95-PCB_thickness,0],
                    [-16.25,-29.95-PCB_thickness,0],
                    [-17.5,-31.2-PCB_thickness,0],
                    [-25,-31.2-PCB_thickness,2],                  //angle hook left
                    [-25,-26.2-PCB_thickness,0],
                    [-23,-26.2-PCB_thickness,0],
                    [-23,-29.2-PCB_thickness,0],
                    [-20,-29.2-PCB_thickness,0],
                    [-19,-9.5-PCB_thickness,0],
                    [-(PCB_length/2)-2.5,-9.5-PCB_thickness,2.5], // angle left top
                    [-(PCB_length/2)-2.5,0,0]];*/
